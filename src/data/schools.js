...
=========================================================================== */
const RAW = [
  ['Annedalsskolan', 'Kommunal', 'Centrum', 'F–6', 'Skansberget 1', 11.9533, 57.6886, 1908, 1998, 4200, 360, 332, 4, 38, 'E', 'ANNEDAL 12:3', 50, 1500],
  ['Nordhemsskolan', 'Kommunal', 'Centrum', 'F–9', 'Stigbergsliden 7', 11.9510, 57.6975, 1886, 2005, 6800, 560, 548, 5, 72, 'F', 'MASTHUGG 8:1', 55, 1450],
  ['Johannebergsskolan', 'Kommunal', 'Centrum', 'F–9', 'V. Rydbergsg. 11', 11.9865, 57.6855, 1924, 2012, 5400, 500, 470, 3, 21, 'D', 'JOHANNEBERG 4:2', 50, 1750],
  ['Guldhedsskolan', 'Kommunal', 'Centrum', 'F–6', 'Doktor Bex gata 5', 11.9720, 57.6840, 1955, 1990, 3900, 300, 288, 4, 29, 'E', 'GULDHEDEN 1:9', 45, 1500],
  ['Kärralundsskolan', 'Kommunal', 'Centrum', 'F–9', 'Solhemsgatan 1', 12.0150, 57.7010, 1969, 2018, 7100, 600, 612, 3, 18, 'C', 'BÖ 32:5', 60, 2100],
  ['Lundenskolan', 'Kommunal', 'Centrum', 'F–9', 'Örnehufvudsg. 1', 12.0080, 57.7090, 1948, 2001, 5900, 480, 455, 4, 34, 'E', 'LUNDEN 14:1', 50, 1600],
  ['Göteborgs Högre Samskola', 'Fristående', 'Centrum', 'F–9', 'Recogatan 14', 11.9760, 57.6960, 1901, 2010, 6400, 520, 510, 2, 0, 'D', 'VASASTADEN 5:7', 50, 0],
  ['Montessoriskolan Elyseum', 'Fristående', 'Centrum', 'F–9', 'Stampgatan 26', 11.9600, 57.7000, 1962, 2015, 2800, 240, 212, 2, 0, 'C', 'GÅRDA 18:3', 25, 0],
  ['IES Göteborg', 'Fristående', 'Centrum', '4–9', 'Mölndalsvägen 93', 11.9920, 57.6800, 1972, 2016, 7800, 760, 742, 2, 0, 'C', 'KROKSLÄTT 109:2', 125, 0],

  ['Bergsjöskolan', 'Kommunal', 'Nordost', 'F–9', 'Rymdtorget 5', 12.0480, 57.7280, 1968, 1994, 8300, 560, 498, 5, 86, 'F', 'BERGSJÖN 25:1', 55, 1550],
  ['Sandeklevsskolan', 'Kommunal', 'Nordost', 'F–9', 'Sandeklevsg. 80', 12.0420, 57.7450, 1965, 1989, 6200, 520, 540, 5, 68, 'F', 'KORTEDALA 41:8', 55, 1500],
  ['Gärdsåsskolan', 'Kommunal', 'Nordost', 'F–6', 'Tellbacken 6', 12.0360, 57.7400, 1961, 1996, 4100, 320, 346, 4, 41, 'E', 'KORTEDALA 28:2', 50, 1550],
  ['Rannebergsskolan', 'Kommunal', 'Nordost', 'F–9', 'Ranneberg C', 12.0500, 57.8100, 1972, 1998, 5600, 440, 468, 4, 52, 'E', 'RANNEBERGEN 7:1', 50, 1650],
  ['Lövgärdesskolan', 'Kommunal', 'Nordost', 'F–9', 'Lövgärdets C', 12.0250, 57.8200, 1970, 1991, 6100, 480, 512, 5, 77, 'F', 'GÅRDSTEN 33:4', 50, 1550],

  ['Toleredsskolan', 'Kommunal', 'Hisingen', 'F–6', 'Toleredsgatan 8', 11.9180, 57.7390, 1957, 2003, 4600, 360, 300, 3, 24, 'D', 'TOLERED 73:2', 45, 1700],
  ['Brunnsboskolan', 'Kommunal', 'Hisingen', 'F–9', 'Tuvevägen 35', 11.9300, 57.7480, 1966, 2009, 6700, 540, 520, 3, 27, 'D', 'BRUNNSBO 1:5', 55, 1900],
  ['Ryaskolan', 'Kommunal', 'Hisingen', 'F–6', 'Ryavägen 4', 11.8900, 57.6950, 2014, 2014, 5200, 420, 398, 1, 4, 'A', 'RYA 4:7', 60, 2500],
  ['Taubeskolan', 'Kommunal', 'Hisingen', 'F–9', 'Vårväderstorget 1', 11.9100, 57.7100, 1959, 1993, 5800, 460, 476, 4, 49, 'E', 'BISKOPSGÅRDEN 830:9', 50, 1600],

  ['Frölundaskolan', 'Kommunal', 'Sydväst', '7–9', 'Nymilsgatan 2', 11.9120, 57.6510, 1963, 1997, 9200, 650, 602, 4, 58, 'E', 'JÄRNBROTT 164:1', 200, 1650],
  ['Önneredsskolan', 'Kommunal', 'Sydväst', 'F–6', 'Önneredsv. 30', 11.8850, 57.6350, 1971, 2008, 4400, 340, 366, 3, 22, 'D', 'ÖNNERED 60:3', 55, 1850],
  ['Påvelundsskolan', 'Kommunal', 'Sydväst', 'F–9', 'Vidkärrsg. 5', 11.8750, 57.6650, 1958, 2002, 5500, 440, 418, 4, 36, 'E', 'ÄLVSBORG 178:1', 45, 1600],
  ['Askimsskolan', 'Kommunal', 'Sydväst', 'F–9', 'Skintebov. 12', 11.9000, 57.6100, 2019, 2019, 6300, 520, 488, 1, 2, 'A', 'ASKIM 24:5', 50, 2600],
]
